...
class ClientStatusStore extends Flux.Store {
  static origin = 'better-status-indicators';
...
module.exports = Flux.Store?.getAll?.().find(store => store.constructor.origin === ClientStatusStore.origin) || new ClientStatusStore(FluxDispatcher, {
